...
#суреттерді салу
player_img = pygame.image.load("C:\\pp2\\lab 8\\assigment1\\player.png")
enemy_img = pygame.image.load("C:\\pp2\\lab 8\\assigment1\\enemy.png")
coin_img = pygame.image.load("C:\\pp2\\lab 8\\assigment1\\coin.png")
background = pygame.image.load("C:\\pp2\\lab 8\\assigment1\\street.png")

#музыканы ашу
accident_sound = pygame.mixer.Sound("C:\\pp2\\lab 8\\assigment1\\sounds\\accident.wav")
coin_sound = pygame.mixer.Sound("C:\\pp2\\lab 8\\assigment1\\sounds\\coin.wav")
music = pygame.mixer.Sound("C:\\pp2\\lab 8\\assigment1\\sounds\\music.ogg")
music.play(-1)
...
while restart:
    ...
    while running:
        ...
        #When player lose, player can see statistics
        while lose:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    restart = False
